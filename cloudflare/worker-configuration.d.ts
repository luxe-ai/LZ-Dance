Warning: truncated output (original token count: 137818)
Total output lines: 14715

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4bdbd0a2359be94d3fd605ce869660d5)
// Runtime types generated with workerd@1.20260804.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	PRACTICE_VIDEOS: R2Bucket;
	AI: Ai;
	SUPABASE_URL: "https://bnjsiltlknqmsnplyjyq.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_peizXMU_IqV7-7nQeKl35A_BFht38tJ";
	ALLOWED_ORIGINS: "http://127.0.0.1:4173,http://localhost:4173,http://127.0.0.1:4174,http://localhost:4174";
}
...
type ChatCompletionContentPartInputAudio = {
   …37818 tokens truncated…pe: string;
                        /**
